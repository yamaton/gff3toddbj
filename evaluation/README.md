...
アノテーションファイルの各行から（エントリ名、feature名、補正なしの位置情報）を要素とする多重集合を作ります。この位置情報にて開始点・終止点にコドンが無いことを示す不等号の存在は無視します。たとえば `join(12..78,134..202)` と `join(<12..78,134..202)`は同じものとみなします。
